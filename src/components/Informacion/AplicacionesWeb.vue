<script>
import { useModal } from '../../assets/js/motion/modal'
    ...
    data(){
        return {
            contactInfo: {
                ...
                message: 'Hola! quiero contactarte con usted para discutir sobre el proyecto de una pagina web profesional para mi empresa o negocio.'
            }
        }
    },
    computed: {
                            ...
                            <div class="space-y-4 sm:space-y-6">
                                ...
                                <div>
                                    <p class="text-slate-700 leading-relaxed text-sm sm:text-base">
                                        Creamos sitios web únicos y efectivos que representan fielmente tu marca y convierten visitantes en clientes. 
                                        Nuestro enfoque combina diseño atractivo, funcionalidad avanzada y optimización para motores de búsqueda.
                                    </p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-1 gap-3">
                                        <div class="flex items-start space-x-3">
                                            <i data-lucide="palette" class="h-4 w-4 sm:h-5 sm:w-5 text-secondary-500 mt-0.5 flex-shrink-0" stroke-width="2.5"></i>
                                            <div>
                                                <span class="font-medium text-slate-800 text-sm sm:text-base">Diseño Personalizado</span>
                                                <p class="text-xs sm:text-sm text-slate-600">Creación única basada en tu identidad de marca</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start space-x-3">
                                            <i data-lucide="smartphone" class="h-4 w-4 sm:h-5 sm:w-5 text-secondary-500 mt-0.5 flex-shrink-0" stroke-width="2.5"></i>
                                            <div>
                                                <span class="font-medium text-slate-800 text-sm sm:text-base">Diseño Responsivo</span>
                                                <p class="text-xs sm:text-sm text-slate-600">Perfecto funcionamiento en todos los dispositivos</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start space-x-3">
                                            <i data-lucide="search" class="h-4 w-4 sm:h-5 sm:w-5 text-secondary-500 mt-0.5 flex-shrink-0" stroke-width="2.5"></i>
                                            <div>
                                                <span class="font-medium text-slate-800 text-sm sm:text-base">Optimización SEO</span>
                                                <p class="text-xs sm:text-sm text-slate-600">Mejor posicionamiento en Google y otros buscadores</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start space-x-3">
                                            <i data-lucide="zap" class="h-4 w-4 sm:h-5 sm:w-5 text-secondary-500 mt-0.5 flex-shrink-0" stroke-width="2.5"></i>
                                            <div>
                                                <span class="font-medium text-slate-800 text-sm sm:text-base">Carga Rápida</span>
                                                <p class="text-xs sm:text-sm text-slate-600">Optimización de velocidad para mejor experiencia</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start space-x-3">
                                            <i data-lucide="shield" class="h-4 w-4 sm:h-5 sm:w-5 text-secondary-500 mt-0.5 flex-shrink-0" stroke-width="2.5"></i>
                                            <div>
                                                <span class="font-medium text-slate-800 text-sm sm:text-base">Seguridad Avanzada</span>
                                                <p class="text-xs sm:text-sm text-slate-600">Certificado SSL y medidas de protección</p>
                                            </div>
                                        </div>
                                        <div class="flex items-start space-x-3">
                                            <i data-lucide="settings" class="h-4 w-4 sm:h-5 sm:w-5 text-secondary-500 mt-0.5 flex-shrink-0" stroke-width="2.5"></i>
                                            <div>
                                                <span class="font-medium text-slate-800 text-sm sm:text-base">Panel de Administración</span>
                                                <p class="text-xs sm:text-sm text-slate-600">Fácil gestión de contenido sin conocimientos técnicos</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Proceso de trabajo -->
                                <div>
                                    <h3 class="text-base sm:text-lg font-semibold text-primary-800 mb-3">Nuestro proceso</h3>
                                    <div class="space-y-3">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <span class="text-slate-700 text-sm sm:text-base">Consulta inicial y análisis de necesidades</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <span class="text-slate-700 text-sm sm:text-base">Diseño de prototipos y estructura</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <span class="text-slate-700 text-sm sm:text-base">Desarrollo y programación</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <span class="text-slate-700 text-sm sm:text-base">Pruebas y optimización</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <span class="text-slate-700 text-sm sm:text-base">Lanzamiento y soporte continuo</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <h3 class="text-base sm:text-lg font-semibold text-primary-800 mb-3">Tipos de páginas web que desarrollamos</h3>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-slate-600">Landing Pages</span>
                                        </div>
                                        <div class="flex items-center space-x-2">
                                            <i data-lucide="check-circle" class="h-3 w-3 sm:h-4 sm:w-4 text-secondary-500 flex-shrink-0"></i>
                                            <span class="text-slate-600">Sitios Corporativos</span>
                                        </div>
                                        <div class="flex items-center space-x-2">
                                            <i data-lucide="check-circle" class="h-3 w-3 sm:h-4 sm:w-4 text-secondary-500 flex-shrink-0"></i>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <i data-lucide="check-circle" class="h-3 w-3 sm:h-4 sm:w-4 text-secondary-500 flex-shrink-0"></i>
                                            <span class="text-slate-600">Tiendas Online</span>
                                        </div>
                                        <div class="flex items-center space-x-2">
                                            <i data-lucide="check-circle" class="h-3 w-3 sm:h-4 sm:w-4 text-secondary-500 flex-shrink-0"></i>
                                            <span class="text-slate-600">Catálogos</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-primary-50 p-3 sm:p-4 rounded-lg">
                                    ...
                                    <p class="text-primary-700 text-xs sm:text-sm">Entre 4-6 semanas dependiendo de la complejidad del proyecto</p>
                                </div>
                            </div>
                        </div>
